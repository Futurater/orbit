                ...
                <form onSubmit={handleEnterOrbit} className="space-y-6">
                    ...
                    >
                        ...
                        <input
                            ...
                            className="w-full bg-black/60 backdrop-blur-md border border-gray-700/80 group-focus-within:border-cyan-500/50 rounded-xl py-4 pl-6 pr-5 text-white placeholder-gray-600 focus:outline-none focus:ring-4 focus:ring-cyan-500/10 transition-all shadow-2xl font-medium"
                        />
                    </motion.div>
